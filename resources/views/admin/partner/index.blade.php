            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{route('partner.create')}}" class="btn btn-success float-right btn-sm"><i
                                    class="fas fa-plus-circle"></i> Add Partner</a>
                    </div>
                    <div class="card-body">
                        <table id="products" class="table">
                            ...
                            @foreach($partners as $partner)
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{asset('images/products/'.$partner->image)}}" alt="Product Image"
                                             style="width: 20px;">
                                    </td>
                                    <td>
                                        <div id="outer">
                                            <a href="{{route('partner.edit', $partner->id)}}" class="btn btn-sm inner"
